...
export default function ProfilePage() {
  ...
  return (
    <div className="flex min-h-screen bg-orange-50">
      {/* Sidebar */}
      <div className="w-20 bg-white shadow-md flex flex-col items-center py-10 gap-8 rounded-r-3xl">
        <FaHome
          className="text-gray-500 text-2xl hover:text-orange-400 cursor-pointer transition"
          onClick={() => navigate("/")}
        />
        <FaShoppingCart
          className="text-gray-500 text-2xl hover:text-orange-400 cursor-pointer transition"
        ...
        />
        <FaClock className="text-gray-500 text-2xl hover:text-orange-400 cursor-pointer transition" />
        <FaChartBar
          className="text-gray-500 text-2xl hover:text-orange-400 cursor-pointer transition"
          onClick={() => navigate("/reports")}
        />
        <FaCog className="text-orange-400 text-2xl cursor-pointer" />
        <FaUserCircle
          className="text-gray-500 text-2xl hover:text-orange-400 cursor-pointer mt-auto transition"
      ...
      {/* Main Content */}
      <div className="flex-1 flex flex-col py-10 px-8 space-y-10">
        <h1 className="text-3xl font-bold text-gray-800">👤 Profile</h1>

        <div className="flex flex-col lg:flex-row gap-10">
          {/* Left Profile Card */}
          <div className="lg:w-1/3 flex flex-col items-center gap-6">
            <div className="bg-white rounded-3xl shadow-lg p-6 flex flex-col items-center w-full hover:shadow-2xl transition">
              <img
                src={employee.image}
                alt={employee.name}
                className="w-32 h-32 object-cover rounded-full border-4 border-orange-400 shadow-md mb-4"
              />
            ...
            <div className="w-full grid grid-cols-2 gap-4">
              <div className="bg-white p-4 rounded-2xl shadow hover:shadow-xl transition flex flex-col items-center">
              ...
              <div className="bg-white p-4 rounded-2xl shadow hover:shadow-xl transition flex flex-col items-center">
                ...
                <span className="font-semibold text-gray-800">{employee.salary}</span>
              </div>
            </div>
          </div>

          {/* Right Form */}
          <div className="lg:flex-1 bg-white rounded-3xl shadow-lg p-8 h-fit overflow-y-auto">
              ...
              <form className="grid grid-cols-1 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-xl p-3 focus:outline-none focus:border-orange-400"
                  />
                </div>
                <div>
            ...
            {activeSection === "login" && (
              <form className="grid grid-cols-1 gap-6">
                <div>
                  <label className="block text-gray-600 font-medium mb-2">Login</label>
                  <input
                    type="text"
                    name="login"
