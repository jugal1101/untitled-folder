...
// apply 
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `
          radial-gradient(circle at center, rgba(0,0,0,0.70) 0%, rgba(0,0,0,0.70) 100%),
    ...
    >
      ...
      <main className="flex-1 flex flex-col p-10 gap-8 overflow-y-auto">
        {/* ================= HEADER ================= */}
        <div className="relative flex flex-col sm:flex-row justify-between items-center gap-4 border-b border-[#c7a86e]/40 pb-4">
          ...
          <div className="relative text-center sm:text-left z-10">
            ...
            <p
              className="text-gray-100 italic text-sm drop-shadow-md"
              style={{ fontFamily: "Dancing Script" }}
            >
              ~ Dil Se Desi
            </p>
            <span className="text-xs text-gray-300 drop-shadow-sm">{currentDate}</span>
          </div>
